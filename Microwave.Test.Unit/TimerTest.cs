...
namespace Microwave.Test.Unit
{
    ...
    public class TimerTest
    {
        ...
        public void Start_TimerExpires_ShortEnough()
        {
            ...
            uut.Start(2);//Før: uut.Start(2000);
        ...
        public void Tick_Started_TimeRemainingCorrect(int ticks)
        {
            ...
            uut.Start(5);//Før: uut.Start(5000);

            // wait for ticks, only a little longer
            pause.WaitOne(ticks * 1000 + 100);

            Assert.That(uut.TimeRemaining, Is.EqualTo(5-ticks));//Før: Assert.That(uut.TimeRemaining, Is.EqualTo(5000-ticks*1000));
        }
    }
}